...
const Herosection = () => {
  return (
    <div>
        ...
        <div className="relative z-10   w-full  flex bg-green-200 pb-10 rounded-b-2xl shadow-xl -mt-5">
          
            <div className="  top-0 left-0 w-full p-2 px-4 flex flex-col md:flex-row justify-center gap-5 -mt-10 ">
